 ...
 *
 * @package    local_enrolreassessmentgroupusers
...
$plugin->version   = 2019032006;        // The current plugin version (Date: YYYYMMDDXX).
$plugin->release  = 'v3.7.0.0';
$plugin->maturity  = MATURITY_STABLE;
$plugin->requires  = 2017050500;        // Requires this Moodle version.
$plugin->component = 'local_enrolreassessmentgroupusers';  // Full name of the plugin (used for diagnostics).
